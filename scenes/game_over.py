...
def game_success_screen(surface, width, height):
    ...
    congrats_text = small_font.render("모든 타워가 활성화되었습니다.", True, (255, 255, 255))
    ...
    while True:
        ...
        # 텍스트 그리기
        surface.blit(success_text, (width // 2 - success_text.get_width() // 2, height // 2 - 100))
        surface.blit(congrats_text, (width // 2 - congrats_text.get_width() // 2, height // 2 - 50))
